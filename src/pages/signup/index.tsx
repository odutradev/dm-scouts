...
const SignUp = () => {
  ...
  const handleInputChange = (field: keyof SignUpData) => (event: React.ChangeEvent<HTMLInputElement>) => setCredentials((prev) => ({ ...prev, [field]: event.target.value }));
